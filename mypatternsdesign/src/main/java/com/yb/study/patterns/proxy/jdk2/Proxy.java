package com.yb.study.patterns.proxy.jdk2;
...
public class Proxy {
    ...
    public static Object newProxyInstance() throws Exception{
        //声明一段源码
        String sourceCode =
                "package org.YB.proxy.jdk2.simulate;"+ RT +
                        "import org.YB.proxy.jdk2.Admin;" + RT +
                        "import org.YB.proxy.jdk2.Manager;" + RT +
                        "//以聚合方式实现的代理主题" + RT +
                        ...
                        "   }" + RT +
                        "}";
        String filename = System.getProperty("user.dir") + "/src/main/java/org/YB/proxy/jdk2/simulate/$Proxy0.java";
        ...
        Class cls = loader.loadClass("org.YB.proxy.jdk2.simulate.$Proxy0");
        //生成代理类对象
